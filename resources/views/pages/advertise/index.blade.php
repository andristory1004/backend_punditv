...
@section('main')
    <div class="text-white justify-center px-5 py-5">
        <div class="flex mt-5 text-white font-medium font-acme space-x-5 text-xs items-center mb-5">
            <a href=""
                class="flex space-x-3 px-6 py-2.5 bg-blue hover:bg-opacity-70 rounded shadow-md hover:shadow-lg active:shadow-lg transition duration-150 ease-in-out h-fit text-center w-fit items-center">
        ...
        <table class="justify-center">
            <thead>
                <tr class="border bg-dark-a">
                    ...
                    <th scope="col" class="px-2 py-2 text-sm font-medium text-white border-r border-white w-36">
                        From
                    </th>
                    <th scope="col" class="px-2 py-2 text-sm font-medium text-white border-r border-white w-36">
                        To
            ...
            <tbody>
                ...
                <tr class="text-white hover:bg-slate-300 hover:text-black border">
                    ...
                    <td class="px-2 py-2 text-sm border-b border-r text-center">Banner</td>
                    <td class="px-2 py-2 text-sm border-b border-r text-center">09-26-2022</td>
                    <td class="px-2 py-2 text-sm border-b border-r text-center">09-29-2022</td>
                    <td class="px-2 py-2 text-sm border-b border-r text-center">Active</td>
                    ...
                    <td class=" text-sm border-b border-r hover:bg-yellow-500 group text-center">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="w-full h-full px-2 py-2">
                ...
                <tr class="text-white hover:bg-slate-300 hover:text-black border">
                    <td class="px-2 py-2 text-sm border-b border-r text-center">{{ $no++ }}</td>
                    <td class="px-2 py-2 text-sm border-b border-r ">Andri</td>
                    <td class="px-2 py-2 text-sm border-b border-r text-center">Vidio</td>
                    <td class="px-2 py-2 text-sm border-b border-r text-center">09-26-2022</td>
                    <td class="px-2 py-2 text-sm border-b border-r text-center">09-29-2022</td>
                    <td class="px-2 py-2 text-sm border-b border-r text-center">Active</td>
                    <td class=" text-sm border-b border-r hover:bg-green-500 group text-center">
